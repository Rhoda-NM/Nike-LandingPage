  ...
  return (
    ...
    >
      <div 
        ...
        <h1 
          className="mt-10 font-palanquin text-8xl max-xm:text-[72px] max-sm:leading-[82] font-bold">
          <span 
      ...
      <div
        ...
        <img 
          ...
          width={600}
          height={500}
          className= "object-contain relative z-10 transition-opacity duration-500 ease-in-out opacity-0 animate-fadeIn"
        />
